...
class Fillup_user(unittest.TestCase):
    ...
    def test_filling(self):
        ...
        self.driver.find_element_by_xpath(Data.mail).send_keys("chetan.goudar@tibilsolutions.com")
        self.driver.find_element_by_xpath(Data.designation).send_keys("Software tester")
        self.driver.find_element_by_xpath(Data.confpass).send_keys("tibil123")
        time.sleep(2)
